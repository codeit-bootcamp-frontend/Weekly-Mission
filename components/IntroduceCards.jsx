  ...
  return (
    <>
      ...
      <div className={cx("card")}>
        ...
        <div className={cx("description")}>
          나만의 폴더를 무제한으로 만들고 <br className={cx("line-break")} />
          다양하게 활용할 수 있습니다.
        </div>
      </div>
      <div className={cx("card")}>
        <div className={cx("title")}>
          저장한 링크를 <span className={cx("gradient3")}>공유</span>해 보세요
        </div>
        <div className={cx("description")}>
          여러 링크를 폴더에 담고 공유할 수 <br className={cx("line-tablet")} />
          있습니다. <br className={cx("line-desktop")} />
          가족, 친구, 동료들에게 쉽고 <br className={cx("line-tablet")} />
          빠르게 링크를 <br className={cx("line-desktop")} />
          공유해 보세요.
        </div>
        <img
          className={cx("card-image", "right-image")}
      ...
      <div className={cx("card")}>
        ...
        />
        <div className={cx("title")}>
          저장한 링크를 <span className={cx("gradient4")}>검색</span>해 보세요
        </div>
        <div className={cx("description")}>
